...
exports.getTests = function (callback) {
    ...
    var sqlgetTests = 'select * from testitems ti inner join  items i inner join tests t inner join types ty ON ti.item = i.item and ti.type= i.type and t.test=ti.test and '+ 
    'ty.type = i.type and t.test=?'
